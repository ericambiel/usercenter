...
export class InventoryDataSource extends DataSource<User> {
  ...
  constructor(public inventoryDatabase: UserService,
  ...
  connect(): Observable<User[]> {
    ...
    this.inventoryDatabase.getAllUsers();


    return merge(...displayDataChanges).pipe(map( () => {
        // Filter data
        this.filteredData = this.inventoryDatabase.data.slice().filter((user: User) => {
  ...
  sortData(dataContrato: User[]): User[] {
